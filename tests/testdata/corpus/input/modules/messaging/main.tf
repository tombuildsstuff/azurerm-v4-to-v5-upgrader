...
resource "azurerm_eventgrid_event_subscription" "eventhub" {
  ...
  eventhub_endpoint_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/example-resources/providers/Microsoft.EventHub/namespaces/example-namespace/eventhubs/example-eventhub"
}
